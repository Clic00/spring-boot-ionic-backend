...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(dtFormat.format(System.currentTimeMillis()), HttpStatus.NOT_FOUND.value(),
	...
	public ResponseEntity<StandardError> dataIntegrityViolation(DataIntegrityException e, HttpServletRequest request) {
		StandardError err = new StandardError(dtFormat.format(System.currentTimeMillis()),
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		ValidationError err = new ValidationError(dtFormat.format(System.currentTimeMillis()),
				HttpStatus.UNPROCESSABLE_ENTITY.value(), "Erro de validação.",
				e.getMessage().substring(0, e.getMessage().indexOf(':')), request.getRequestURI());
	...
	public ResponseEntity<StandardError> authorization(AuthorizationException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(dtFormat.format(System.currentTimeMillis()), HttpStatus.FORBIDDEN.value(),
				"Autorização negada.", e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(dtFormat.format(System.currentTimeMillis()), code.value(),
