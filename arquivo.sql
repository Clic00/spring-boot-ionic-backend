...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Expediente'),(4,'Cama,mesa e banho'),(5,'Eletrônicos'),(6,'Jardinagem'),(7,'Perfumaria');
...
INSERT INTO `cidade` VALUES (1,'Belém',1),(2,'Uberlândia',2),(3,'Campinas',3),(4,'Irituia',1);
...
INSERT INTO `cliente` VALUES (1,'243.354.005-56','meire@indra.com','Maria Meire',1),(2,'132.143.655-90','tialinda@gmail.com','Rosana Kalil',2);
...
INSERT INTO `endereco` VALUES (1,'Jardins','38220834','Apto 203','Rua Flores','300',1,1),(2,'Centro','38777012','Sala 800','Avenida Matos','105',4,1),(3,'Reduto','66045-67','Apto. 206','Av. Doca de Souza Franco','902',3,2);
...
INSERT INTO `estado` VALUES (1,'Pará'),(2,'Minas Gerais'),(3,'São Paulo');
...
INSERT INTO `pagamento` VALUES (1,3),(2,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Papel A4',10),(5,'Toalha',50),(6,'Colcha',200),(7,'TV true color',1200),(8,'Roçadeira',800),(9,'Toner p/ impressora',100),(10,'Fita gomada',180),(11,'Shampoo',90);
...
INSERT INTO `produto_categoria` VALUES (1,1),(1,5),(2,1),(2,2),(2,5),(3,1),(3,5),(4,2),(4,3),(5,4),(6,4),(7,5),(8,6),(9,3),(10,3),(11,7);
...
INSERT INTO `telefone` VALUES (1,'(51)4356-5678'),(1,'(51)98789-5677'),(2,'(91)-3454-9800'),(2,'(51)9876-9876');
...
-- Dump completed on 2018-01-08 17:54:49
